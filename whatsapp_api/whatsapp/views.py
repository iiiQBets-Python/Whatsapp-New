...
def send_message(phone_number, template, media_id=None, media_type=None, variables=None):
    url = "https://graph.facebook.com/v19.0/361527550367283/messages"
    headers = {
        "Authorization": "Bearer EAAEV10GXT10BO40te5eWQ2KBqyZCZB8jTFEZBGH6SZCzItuQvgDbjsajUoknt2JblHqBkqmcgF17lgkZBzSuiHnKdVhQkCZAMTSNUz60uHzUwT2jwNhYR8kGZAlFqXYL1CZCK6EIdGgNDEZBRKBnimp3n8ewI1ueGDXFSlgkMzti7UwYB8Ljy70OF57vde8dXOE9ZALAZDZD",
    ...
    response_data = response.json() if response.status_code == 200 else {"error": "No JSON response"}
...
def Media_Id_Generator(media_file):
    url = "https://graph.facebook.com/v19.0/361527550367283/media"
    headers = {
        "Authorization": "Bearer EAAEV10GXT10BO40te5eWQ2KBqyZCZB8jTFEZBGH6SZCzItuQvgDbjsajUoknt2JblHqBkqmcgF17lgkZBzSuiHnKdVhQkCZAMTSNUz60uHzUwT2jwNhYR8kGZAlFqXYL1CZCK6EIdGgNDEZBRKBnimp3n8ewI1ueGDXFSlgkMzti7UwYB8Ljy70OF57vde8dXOE9ZALAZDZD"
    }
    files = {
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            for contact in group.numbers.all():
                variables = [contact.name] if contact.name else []  # Pass the name as a variable, if available
